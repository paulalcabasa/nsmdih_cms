...
class Transaction extends MY_Controller {
    ...
    public function ajax_add_new_transaction(){
       ...
       // $temp_transaction_id = $this->input->post('temp_transaction_id');
        $attribute1 = $this->input->post('attribute1');
        $attribute2 = $this->input->post('attribute2');
        ...
        if(!$is_error){ // if there is no errors
            ...
            if ($this->db->trans_status() === FALSE) {
                ...
                $message = "Unexpected error has happened, transaction was not saved, please refresh the page and contact the system administrator.";
            }
            else {
    ...
    //    $pending_transactions_ctr = $this->transaction_model->count_pending_transactions();
        ...
        $transactions = $this->transaction_model->get_transactions($start_date,$end_date);
