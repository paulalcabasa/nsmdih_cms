<div class="content-wrapper"> <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content"> <!-- Main content -->
        <form id="frm_debit_xls" name="frm_debit_xls" method="POST" enctype="multipart/form-data" action="import_customer_debits" class="hidden">
            ...
            <input type="hidden" name="employee_type" value="1"/><!--  employee type is same as person type 19 which is SRUHO employee -->
        </form>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">Sytem Message</h4>
          </div>
        ...
        if(index > 0){
            ...
            $.ajax({
                ...
                data:{
                    ...
                    employee_type : "mdi_actg"
                },
                url:"ajax_export_selected_employees_credit",
                success:function(response){
                   //... How to use it:
                     $("#modal_info").modal('hide');
                    downloadURL('<?php echo base_url();?>files/exported_employees/employee_credits_mdi_actg.xls');
                }
            });
        }
        else {
