...
class Transaction_model extends CI_Model {
	...
	public function get_transactions($start_date,$end_date){
		$sql = "SELECT 
			        ...
			        th.id transaction_no,
			        pt.person_type_name AS customer_type,
			        th.customer_name AS customer_name,
			        th.total_amount AS total_amount,
			        DATE_FORMAT(th.date_created, '%m/%d/%Y %l:%i %p') AS transaction_date,
			        ts.status AS status,
			        th.date_created AS date_created,
			        th.transaction_status AS transaction_status,
			        th.person_id AS person_id,
			        th.person_type_id AS person_type_id,
			        th.employee_no AS employee_no,
			        th.patient_room_no AS patient_room_no,
			        th.patient_reference_no AS patient_reference_no
