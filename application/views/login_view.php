...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>ez</b>CMS</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <?php echo form_open('login/validate_credentials');?>
      ...
      <div class="form-group has-feedback">
        ...
        <span class='help-block login-error-msg'><?php echo form_error('username');?></span>
      </div>
      <div class="form-group has-feedback">
        ...
        <span class='help-block login-error-msg'><?php echo form_error('password');?></span>
      </div>
      <div class="row">
        <div class="col-xs-8">
...
<!-- jQuery 2.2.3 -->
<script src="<?php echo base_url();?>plugins/jquery/jquery-3.0.0.min.js"></script>
<!-- Bootstrap 3.3.6 -->
