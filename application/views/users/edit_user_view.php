...
<div class="content-wrapper"> <!-- Content Wrapper. Contains page content -->
    ...
    <section class="content"> <!-- Main content -->
	    ...
	    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="<?php echo base_url();?>user/update_user_details" id="frm_update_user" name="frm_update_user">
		    ...
		    <input type="hidden" name="department_id" id="department_id" value="<?php echo $person_details->department_id;?>" />
		    ...
		    <input type="hidden" value="<?php echo $person_details->person_state_id;?>" name="state"/>
		        ...
		        <div class="box-body">
		        		...
		        		<div class="col-md-6">
			        		...
			        		<div class="form-group">
			        			...
			        			<div class="col-md-9">
			        				<input type="text" readonly="readonly" maxlength="50" class="form-control" placeholder="First Name" name="first_name" value="<?php echo $person_details->first_name;?>"/>
			        		...
			        		<div class="form-group">
			        			...
			        			<div class="col-md-9">
			        				<input type="text" readonly="readonly" maxlength="50" class="form-control" placeholder="Middle Name" name="middle_name" value="<?php echo $person_details->middle_name;?>"/>
			        		...
			        		<div class="form-group">
			        			...
			        			<div class="col-md-9">
			        				<input type="text" readonly="readonly" maxlength="50" class="form-control" placeholder="Last Name" name="last_name" value="<?php echo $person_details->last_name;?>"/>
			        		...
			        		<div class="form-group">
			        			...
			        			<div class="col-md-9">
			        				<input type="text" readonly="readonly" class="form-control" placeholder="Department" value="<?php echo $person_details->department_name;?>"/>
			        			</div>
			        		</div>
			        		...
			        		<div class="form-group">
			        			...
			        			<div class="col-md-9">
				        			...
				        			foreach($person_types as $type){
				        				...
				        				if(in_array($type->id,$allowed_user_types) ){
				        			?>
...
<?php } else { ?>
<input type="hidden" name="sel_user_type" value="<?php echo $person_details->person_type_id;?>" />
<?php  }?>
