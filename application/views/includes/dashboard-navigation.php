          ...
          <li class="dropdown user user-menu">
            ...
            <!--   <li class="user-body">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo $profile_link . encode_string($this->session->userdata('person_id'));?>" class="btn btn-default btn-flat">Profile</a>
                </div>
...
<!--         <li class="header">MAIN NAVIGATION</li>
        ...
        <?php } ?>  
      	 ...
      	 <li class="header">ACCOUNTING</li>
         <li><a href="<?php echo base_url();?>employee/credit_management_mdi"><i class="ion-person-stalker"></i> <span>Credit Management</span></a></li>
	<li><a href="<?php echo base_url();?>employee/credit_management"><i class="ion-person-stalker"></i> <span>Credit Report</span></a></li>
      	<?php } ?>
