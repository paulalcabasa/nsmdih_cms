			        ...
			        <div class="box-body">
						...
						?>
							<div class="col-md-4 col-sm-6 col-xs-12">
								<div class="box box-danger food-container"  id='fd_<?php echo $food->food_id?>'>
									<div class="box-body">
										<div class="food-img-wrapper">
											<img src="<?php echo $meal_img_dir . $food_image;?>" class="img-responsive"/>
										</div>
										<div class="food-description">
											<div class="food-name-wrapper">
												<span class="food-name"><?php echo strip_str_ellipsis($food->food_name,47);?></span><br/>	
											</div>
											<div class="row">
												<div class="col-md-<?php echo ($food->quantity > 0) ? "8" : "12"; ?>">
													<span class="food-price text-danger">Price : <?php echo $food->unit_price;?></span><br/>
													<span class="food-available-quantity text-muted">Quantity : <span class='food-qty'><?php echo ($food->quantity != 0 ? $food->quantity : "Out of stock!");?></span></span>
												</div>
												...
												<div class="col-md-4">
													...
													<button type="button" 
															...
															data-price="<?php echo $food->unit_price;?>"
															data-qty="<?php echo $food->quantity;?>" 
															data-food_id="<?php echo $food->food_id;?>"
...
$(document).ready(function(){
	...
	$("body").on("click",".btn-add-to-order",function(){
		...
		var currenty_food_qty_elem = $(this).parent().parent().children().find("span:nth-child(3)").find("span[class=food-qty]");
...
person_id != "" && barcode_no != "" && meal_allowance_id != ""){*/
		if(orders_index > 0){ // check if orders exist
			if(customer_type == 8 || customer_type == 1){ // if customer is employee or stockholder, require person_id
				if(person_id != "" && employee_no != "" && barcode_no !="" && meal_allowance_id != ""){
