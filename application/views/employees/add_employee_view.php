<div class="content-wrapper"> <!-- Content Wrapper. Contains page content -->
    <section class="content-header"> <!-- Content Header (Page header) -->
        <h1>New Employee
            <small>This page is used for adding a <strong>new employee</strong> into the system.</small>
        </h1>
    </section>
    ...
    <section class="content"> <!-- Main content -->
		...
		<?php } ?>
	    <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="<?php echo base_url();?>employee/save_new_employee" id="frm_new_employee" name="frm_new_employee">
		    <div class="box"> <!-- Default box -->
		    	<div class="box-header with-border">
	            	<h3 class="box-title">Employee Information Entry</h3>
	        	</div>
		        <div class="box-body">
		        		<input type="file" id="person_image" name="person_image" class="hidden" onchange="PreviewImage('person_image','person_pic')"/>
		        		<div class="col-md-6">
		        			<div class="form-group">
		        				<input type="hidden" maxlength="30" class="form-control" placeholder="Employee Number" name="person_type_id" value="<?php echo $person_type_id;?>" />
			        			<label class="col-md-3 control-label">Employee No</label>
			        			<div class="col-md-9">
			        				<input type="text" maxlength="30" class="form-control" placeholder="Employee Number" name="employee_no" value="<?php echo set_value('employee_no');?>" />
