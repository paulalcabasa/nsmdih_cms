...
<div class="content-wrapper"> <!-- Content Wrapper. Contains page content -->
    ...
    <div class="nav-tabs-custom" style="min-height:550px;">
            <ul class="nav nav-tabs ">
                <li class="active"><a href="#employees_tab" class="btn_get_employees" data-person_state_id="1" data-toggle="tab">Active</a></li>
                <li class=""><a href="#employees_tab" class="btn_get_employees" data-person_state_id="2" data-toggle="tab">Inactive</a></li>
