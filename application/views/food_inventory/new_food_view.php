       ...
       <!--  <div class="alert alert-success alert-dismissible">
        ...
        <div class="box"> <!-- Default box -->
            ...
            <div class="box-body">
                ...
                <table class="table table-bordered" id="tbl_food_ingredients" style="font-size:90%;">
                    <thead>
                        <tr>
                            <th style="width:10%;">Item No</th>
                            <th style="width:30%;">Food Item</th>
                            <th style="width:10%;">Quantity</th>
                            <th style="width:10%;"><abbr title="Remaining">Rem</abbr> Quantity</th>
...
function add_ingredient_row(){
    ...
    $("#sel_food_item_" + food_item_index).select2({
        ...
        templateResult : function(data){
            ...
            var $result = $(
                '<div class="row" style="font-size:85%;margin:0;padding:0;">' + 
                    '<div class="col-md-3">' + r[0] + '</div>' + 
                    '<div class="col-md-3">' + r[1] + '</div>' + 
                    '<div class="col-md-6">' + r[2] + '</div>' + 
                '</div>'
            );
            return $result;
        }
...
$(document).ready(function(){
    ...
    $("body").on("change",".sel_food_item",function(){
        ...
        element_to_remove = $("#sel_base_item_options option[data-inventory_item_stock_id='"+inventory_item_stock_id+"']");
